...
layout: docs
category: APIs
permalink: Docs/APIs/layout-props.md
...
- [`borderBottomWidth`] (have not supported)
- [`borderEndWidth`] (have not supported)
- [`borderLeftWidth`] (have not supported)
- [`borderRightWidth`] (have not supported)
- [`borderStartWidth`] (have not supported)
- [`borderTopWidth`] (have not supported)
- [`borderWidth`] (have not supported)
- [`bottom`](#bottom)
- [`display`](#display)
- [`end`](#end)
- [`flex`](#flex)
...
- [`top`](#top)
- [`width`](#width)
- [`zIndex`] (have not supported)
- [`direction`](have not supported)
