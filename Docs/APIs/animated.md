...
- [`Animated.spring()`](#spring) provides a simple spring physics model.
- [`Animated.timing()`](#timing) animates a value over time using [easing functions](docs/easing.html).
