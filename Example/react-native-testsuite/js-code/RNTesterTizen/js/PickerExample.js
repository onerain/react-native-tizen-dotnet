...
class PickerExample extends React.Component {
  ...
  render() {
    return (
      <RNTesterPage title="<Picker>" enabled={false}>
        ...
        <View style= {{flexDirection:'row'}}>
          ...
          <Text style = {{color:'black',left:200}} >
          {this.state.selected1}
          </Text>
          </View>
        </RNTesterBlock>
        <RNTesterBlock title="Disabled picker" enabled={false}>
          <Picker title={this.state.title} style={styles.picker}
            enabled={false} selectedValue={this.state.selected1}>
            <Item label="hello" value="key0" />
            <Item label="world" value="key1" />
          </Picker>
        </RNTesterBlock>
        <RNTesterBlock title="Dropdown Picker" enabled={false}>
          <Picker
            title={this.state.title}
            style={styles.picker}
