...
YGNodeRef YGNodeNewWithConfig(const YGConfigRef config);
...
#define YG_NODE_STYLE_PROPERTY_UNIT(type, name, paramName)                                    \
  ...
  void YGNodeStyleSet##name##Percent(const YGNodeRef node, const float paramName); \
  type YGNodeStyleGet##name(const YGNodeRef node);
...
#define YG_NODE_STYLE_EDGE_PROPERTY(type, name, paramName)    \
  void YGNodeStyleSet##name(const YGNodeRef node,  \
                                       const YGEdge edge,     \
