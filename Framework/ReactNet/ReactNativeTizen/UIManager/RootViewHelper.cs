...
namespace ReactNative.UIManager
{
    ...
    public static class RootViewHelper
    {
        ...
        public static ReactRootView GetRootView(EvasObject view)
        {
            var current = view;
            while (true)
            {
        ...
        public static IEnumerable<EvasObject> GetReactViewHierarchy(EvasObject view)
        {
            var current = view;
            while (true)
            {
        ...
        /// <code>false</code>.
        /// </returns>
        public static bool IsReactSubview(EvasObject view)
        {
            return GetReactViewHierarchy(view).GetEnumerator().MoveNext();
        }

        private static EvasObject GetParent(EvasObject view, bool findRoot)
        {
            //
            ...
            // Otherwise, we just use the Widget.Parent property.
            // 
