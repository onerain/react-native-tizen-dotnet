...
namespace ReactNative.UIManager
{
    ...
    public interface IViewManager
    {
        ...
        void UpdateProperties(Widget viewToUpdate, ReactStylesDiffMap props);
        ...
        Widget CreateView(ThemedReactContext reactContext/*, JavaScriptResponderHandler responderHandler*/);
        ...
        /// </remarks>
        void OnDropViewInstance(ThemedReactContext reactContext, Widget view);
        ...
        void UpdateExtraData(Widget root, object extraData);
        ...
        void ReceiveCommand(Widget view, int commandId, JArray args);
        ...
        Dimensions GetDimensions(Widget view);
        ...
        void SetDimensions(Widget view, Dimensions dimensions);
    }
}
