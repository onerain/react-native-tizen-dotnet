...
namespace ReactNative.UIManager
{
    ...
    public class LayoutShadowNode : ReactShadowNode
    {
        ...
        public void SetPositionValues(int index, JValue position)
        {
            ...
            {
                string[] strarray = {ViewProps.Left,ViewProps.Right,ViewProps.Top,ViewProps.Bottom };
                throw new InvalidOperationException("Property Error: " + strarray[index] + " with " + ex.Message);
            }
        }
