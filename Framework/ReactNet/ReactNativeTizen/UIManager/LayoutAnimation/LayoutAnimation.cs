...
*/
        ...
        public IObservable<Unit> CreateAnimation(Widget view, Dimensions dimensions)
        {
            if (!IsValid)
            {
                return null;
        ...
        public void Reset()
        {
            ...
            //Interpolator = default(EasingFunctionBase);   TODO:
        }
        ...
        /// <param name="dimensions">The view dimensions.</param>
        /// <returns>The storyboard.</returns>
        protected abstract IObservable<Unit> CreateAnimationCore(Widget view, Dimensions dimensions);
    }
}
